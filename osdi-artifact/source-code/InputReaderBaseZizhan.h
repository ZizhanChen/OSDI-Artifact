...
#ifndef _UI_INPUT_READER_BASE_ZIZHAN_H
#define _UI_INPUT_READER_BASE_ZIZHAN_H
...
class InputReaderInterfaceZizhan : public virtual RefBase {
protected:
    InputReaderInterfaceZizhan() { }
    virtual ~InputReaderInterfaceZizhan() { }
...
class InputReaderThreadZizhan : public Thread {
public:
    explicit InputReaderThreadZizhan(const sp<InputReaderInterface>& reader);
    virtual ~InputReaderThreadZizhan();
...
struct TouchAffineTransformationZizhan {
    float x_scale;
    float x_ymix;
    float x_offset;
    float y_xmix;
    ...
    TouchAffineTransformationZizhan() :
        x_scale(1.0f), x_ymix(0.0f), x_offset(0.0f),
        y_xmix(0.0f), y_scale(1.0f), y_offset(0.0f) {
    }

    TouchAffineTransformationZizhan(float xscale, float xymix, float xoffset,
...
//    virtual TouchAffineTransformationZizhan getTouchAffineTransformation(
//            const std::string& inputDeviceDescriptor, int32_t surfaceRotation) = 0;
    
//    virtual int32_t notifyLayerstackChanged() = 0; 
//};

} // namespace android

#endif // _UI_INPUT_READER_COMMON_ZIZHAN_H
