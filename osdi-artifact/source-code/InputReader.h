...
private:
    ...
    sp<InputReaderZizhan> mInputReaderZizhan;
    ...
    //RawEvent mEventBufferZizhan[EVENT_BUFFER_SIZE];
...
//extern void processEventsZizhan(const RawEvent* rawEvents, size_t count);
