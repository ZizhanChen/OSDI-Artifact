...
void NativeInputManager::setDisplayViewports(JNIEnv* env, jobjectArray viewportObjArray) {
    ...
    //zizhan
    //std::string dumpZizhan;
    //dump(dumpZizhan);
    //ALOGD("[zizhan setDisplayViewports] %s", dumpZizhan.c_str());
...
void NativeInputManager::setInputWindows(JNIEnv* env, jobjectArray windowHandleObjArray,
    ...
    //std::string dumpZizhan;
    //dump(dumpZizhan);
    //ALOGD("[zizhan setInputWindows] %s", dumpZizhan.c_str());
    if (changes) {
...
void NativeInputManager::setPointerSpeed(int32_t speed) {
    ...
    //std::string dumpZizhan;
    //dump(dumpZizhan);
    //ALOGD("[zizhan setPointerSpeed] %s", dumpZizhan.c_str());
    mInputManager->getReader()->requestRefreshConfiguration(
...
void NativeInputManager::setInputDeviceEnabled(uint32_t deviceId, bool enabled) {
    ...
    //std::string dumpZizhan;
    //dump(dumpZizhan);
    //ALOGD("[zizhan setInputDeviceEnabled] %s", dumpZizhan.c_str());
    mInputManager->getReader()->requestRefreshConfiguration(
...
void NativeInputManager::setShowTouches(bool enabled) {
    ...
    //std::string dumpZizhan;
    //dump(dumpZizhan);
    //ALOGD("[zizhan setShowTouches] %s", dumpZizhan.c_str());
    mInputManager->getReader()->requestRefreshConfiguration(
...
void NativeInputManager::setPointerCapture(bool enabled) {
    ...
    //std::string dumpZizhan;
    //dump(dumpZizhan);
    //ALOGD("[zizhan setPointerCapture] %s", dumpZizhan.c_str());
    mInputManager->getReader()->requestRefreshConfiguration(
...
void NativeInputManager::reloadCalibration() {
    ...
    //std::string dumpZizhan;
    //dump(dumpZizhan);
    //ALOGD("[zizhan reloadCalibration] %s", dumpZizhan.c_str());
    mInputManager->getReader()->requestRefreshConfiguration(
