...
#ifndef ANDROID_HWC2_ZIZHAN_H
#define ANDROID_HWC2_ZIZHAN_H
...
// HWC2Zizhan::Device::registerCallback(). It's used to help differentiate callbacks
...
{
public:
    explicit Device(std::unique_ptr<android::Hwc2Zizhan::Composer> composer);
    ...
    android::Hwc2Zizhan::Composer* getComposer() { return mComposer.get(); }
...
private:
    ...
    // Member variables
    std::unique_ptr<android::Hwc2Zizhan::Composer> mComposer;
...
class Display : public HWC2Zizhan::Display {
public:
    Display(android::Hwc2Zizhan::Composer& composer, const std::unordered_set<Capability>& capabilities,
    ...
    Error setActiveConfig(const std::shared_ptr<const HWC2Zizhan::Display::Config>& config) override;
...
private:
    ...
    // These are references to data owned by HWC2Zizhan::Device, which will outlive
    // this HWC2Zizhan::Display, so these references are guaranteed to be valid for
    // the lifetime of this object.
    android::Hwc2Zizhan::Composer& mComposer;
...
class Layer : public HWC2Zizhan::Layer {
public:
    Layer(android::Hwc2Zizhan::Composer& composer,
...
private:
    // These are references to data owned by HWC2Zizhan::Device, which will outlive
    // this HWC2Zizhan::Layer, so these references are guaranteed to be valid for
    // the lifetime of this object.
    android::Hwc2Zizhan::Composer& mComposer;
    const std::unordered_set<Capability>& mCapabilities;
