...
#ifndef ANDROID_COMPOSER_HAL_ZIZHAN_H
#define ANDROID_COMPOSER_HAL_ZIZHAN_H
...
class Composer final : public Hwc2Zizhan::Composer {
public:
...
#endif // ANDROID_COMPOSER_HAL_ZIZHAN_H
